...
import { idlFactory } from './dbanks_assets.did.js';
export { idlFactory } from './dbanks_assets.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.DBANKS_ASSETS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dbanks_assets.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dbanks_assets canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dbanks_assets.did.js")._SERVICE>}
 */
export const dbanks_assets = createActor(canisterId);
